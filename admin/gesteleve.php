                        ...
                        <div class="card-body">
                            <form method="POST" class="needs-validation row" novalidate>
                                <div class="mb-3 col-lg-3">
                                    ...
                                    <input type="text" class="form-control" name="nom" id="validationCustom01"
                                ...
                                <div class="mb-3 col-lg-3">
                                    ...
                                    <input type="text" class="form-control" name="prenom" id="validationCustom02"
                                ...
                                <div class="mb-3 col-lg-3">
                                    ...
                                    <input type="text" class="form-control" name="parent" id="validationCustom02"
                                ...
                                <div class="mb-3 col-lg-3">
                                    ...
                                    <input type="text" class="form-control" name="naissance" id="validationCustom03"
                                ...
                                <div class="mb-3 col-lg-3">
                                    ...
                                    <input type="text" class="form-control" name="ville" id="validationCustom04"
                                ...
                                <div class="mb-3 col-lg-3">
                                    ...
                                    <input type="text" class="form-control" name="telephone" id="validationCustom05"
